...
getLibDir = catchIO (getEnv "cssmanip_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "cssmanip_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "cssmanip_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "cssmanip_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "cssmanip_sysconfdir") (\_ -> return sysconfdir)
